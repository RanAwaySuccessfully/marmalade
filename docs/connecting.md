...
As long as you have it enabled, it will try to connect to VTube Studio (asking for permission if it's the first time). You can manually select if you want to send face tracking and/or hand tracking data.
