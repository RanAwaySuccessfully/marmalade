...
XDG_CACHE_HOME=/tmp
bazel-7.4.1 clean
bazel-7.4.1 build  --verbose_failures --distdir=$LOCALREPOS -c opt --linkopt -s --strip never --copt -DMESA_EGL_NO_X11_HEADERS --copt -DEGL_NO_X11 //mediapipe/tasks/c:libmediapipe.so
